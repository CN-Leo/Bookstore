...
public class DESTools
{
     ...
     * 密钥
     */
    private static byte[] BOSS_SECRET_KEY = {0x0b, 0x13, (byte) 0xe7, (byte) 0xb2, 0x51, 0x0d, 0x75, (byte) 0xc2, 0x4e, (byte) 0xdd, (byte) 0x4b,
            (byte) 0x51, 0x24, 0x36, (byte) 0xa8, (byte) 0x28, 0x0b, 0x13, (byte) 0xe2, (byte) 0xb2, 0x31, 0x0d, 0x75, (byte) 0xc1};
...
//        String str1 = " LKu+vKP7T5xZ7gyb0Rg6qzbcCdpNMlyWYjGLYNFWlYk=";
        // DES加密
//        String str2 = des.getEncString(str1);
        String deStr = des.getDesString("LKu+vKP7T5xZ7gyb0Rg6qzbcCdpNMlyWYjGLYNFWlYk=");
       // System.out.println("密文:" + str2);
        System.out.println("明文:" + deStr);
        // System.out.println("密文:" + URLEncoder.encode(str2, "UTF-8"));
        // DES解密
        // System.out.println("明文:" + URLDecoder.decode(deStr, "UTF-8"));
    }
}
